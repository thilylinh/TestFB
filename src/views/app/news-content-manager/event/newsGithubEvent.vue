    ...
    <b-form class="content-form ndev-form">
      <b-row>
        <b-col lg="12" md="12" sm="12" xs="12">
          <label class="font-weight-700">1. Tên GitHub</label>
        </b-col>
        <b-col lg="12" md="12" sm="12" xs="12">
          <b-form-input
      ...
      <b-row class="mt-1">
        <b-col lg="12" md="12" sm="12" xs="12">
          <label class="font-weight-700">2. Mã GitHub</label>
        </b-col>
        <b-col lg="12" md="12" sm="12" xs="12">
          <b-form-input
            id="roomManagerEvent_txtCode"
            v-model="$v.form.code.$model"
            :state="!$v.form.code.$error"
            autocomplete="off"
            placeholder="Nhập mã GitHub ..."
          />
      ...
      <b-row class="mt-1">
        <b-col class="mt-1" lg="12" md="12" sm="12" xs="12">
          <label class="font-weight-700">3. Mô tả</label>
        </b-col>
        <b-col lg="12" md="12" sm="12" xs="12">
          <textarea
            rows="3"
...
export default {
  ...
  data() {
    return {
      idModal: "newsGitHubEventModalId",
      titleModal: "",
      modalData: [],
      form: {
        description: "",
          ...
          const iResult =
            this.modalData.type === "add"
              ? await NCoreHelper.v2executePOST(
                  this,
                  NewsGitHubApi.NewsGithub_CREATE,
                  this.form
                )
              : await NCoreHelper.v2executePUT(
                  this,
                  NewsGitHubApi.NewsGithub_UPDATE,
                  this.form
                );
          if (iResult) {
