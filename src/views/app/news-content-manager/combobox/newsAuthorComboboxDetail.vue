          ...
          <b-table-simple hover small caption-top responsive bordered striped style="overflow-x: hidden;">
            <b-thead head-variant="dark">
              <b-tr style="font-size: 10px;" class="text-justify">
                ...
                <b-th class="text-center">TÊN TÁC GIẢ</b-th>
              </b-tr>
            </b-thead>
...
export default {
  ...
  data() {
    return {
      pageIdModal: "newsGroupTypeComboboxDetailIdModal",
      newsGroupTypeData: [],
  ...
  methods: {
    ...
    async callNewsGroupType() {
      ...
      const iResult = await NCoreHelper.v2executeGET(this, newsContentApi.NEWS_CONTENT_NEWS_AUTHOR, {
        search: this.newsGroupTypeSearch,
        pageSize: 10,
        pageNumber: this.newsGroupTypePageNumber,
        statusId: NCoreConfig.projectActiveData
      })
      this.newsGroupTypeData = iResult;
